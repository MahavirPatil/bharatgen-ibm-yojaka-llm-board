...
def build_prompt_from_request(req: Any, chunk_text: str) -> str:
    ...
    prompt = (
        ...
        "6. ANSWER LENGTH: The answer MUST be a comprehensive, long-form essay. It must contain a clear Introduction, multiple distinct Body Paragraphs exploring deep critical analysis, and a definitive Conclusion.\n\n"
